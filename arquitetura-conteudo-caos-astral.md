...
├── /intento                      → visão pessoal, o "porquê" por trás de tudo (novo)
...
├── /raizes                       → seção de história e proveniência (nova)
│   ├── /raizes/magia-do-caos
│   ├── /raizes/astrologia
│   ├── /raizes/i-ching
│   └── /raizes/simbolos-sabianos
...
### `/raizes/simbolos-sabianos`
- Marc Edmund Jones e Elsie Wheeler, 1925, domínio público
- Espaço natural pra história do pai como proveniência real e verificável — o oposto de apropriação estética
