...
(function () {
  ...
  // ---- L4 / L5 (Nuvens de Kordylewski): não têm mecânica orbital
  // própria, são definidos como ±60° da longitude da Lua no instante
  // (triângulo equilátero Terra-Lua-ponto, Lagrange 1772). Ver
  // enciclopedia_simbolos slug "pontos-l4-l5" e supabase/functions/
  // _shared/l4l5.ts (mesmo cálculo, versão Deno/Edge Function).
  // L4 = adiantado (+60°, na direção do movimento da Lua), L5 = atrasado
  // (-60°). Não oscilam de forma independente (sempre 120° um do outro),
  // por isso 'neverRetro' em BODIES: não fazem sentido como retrógrados,
